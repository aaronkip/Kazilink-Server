        ...
        <div class="content-wrapper">
              ...
              <div class="card card-statistics">
                <div class="card-body">
                  ...
                  <p class="text-muted mt-3">
                    <i class="mdi mdi-alert-octagon mr-1" aria-hidden="true"></i> Work Revenue
                  </p>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
              <div class="card card-statistics">
                <div class="card-body">
                  ...
                  <p class="text-muted mt-3">
                    <i class="mdi mdi-bookmark-outline mr-1" aria-hidden="true"></i> Products of Artist
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="card card-statistics">
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      <p class="card-text text-right">Artists</p>
                      <div class="fluid-container">
                  ...
                  <p class="text-muted mt-3">
                    <i class="mdi mdi-reload mr-1" aria-hidden="true"></i> Total Artists
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title mb-4">Monthly Revenue in <?php echo $currency_type; ?></h5>
          ...
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title mb-4">Recent completed Work</h5>
                    ...
                    <table class="table center-aligned-table">
                      <thead>
                        <tr>
                          ...
                          <th class="border-bottom-0">Artist Service</th>
                          <th class="border-bottom-0">Date & Time</th>
                          <th class="border-bottom-0">Working Mintues</th>
                      ...
                      <?php $i=0; foreach ($getInvoices as $getInvoices) {
                        ...
                        <tr>
                          ...
                          <td><?php echo $currency_type; echo $getInvoices->total_amount; ?></td>
